...
class Database {
    ...
    deleteRestaurant(id) {
        ...
        // Restorant silince yemeklerini de sil
    ...
    addOrder(restaurantId, items, total, userPhone) {
    ...
    updateUser(name, phone, email) {
        ...
        user = { ...user, name, phone, email, isNew: false };
    ...
    const html = `
        <div class="profile-card">
            ...
            <div class="profile-actions">
                ...
                <button class="btn btn-danger" onclick="logoutUser()">Çıkış Yap</button>
            </div>
        </div>
    `;
...
function logoutUser() {
    if (confirm('Çıkış yapmak istediğinizden emin misiniz?')) {
        ...
        db.initializeData();
        alert('Çıkış yapıldı. Sayfa yenilenecek.');
        location.reload();
    }
}
